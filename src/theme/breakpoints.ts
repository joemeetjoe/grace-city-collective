 ...
 * the scene, the lockup stacks (layout/useBelowLg.ts) and the mobile asset
...
/** the media queries either side of it: `lg:` and its complement, as the script and the static splash write them */
